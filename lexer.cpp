...
void add_token(std::vector<Token>& tokens, TokenType type, const std::string& value);
...
void lexer(const std::string& sourceCode) {
    ...
    for (const auto& token : tokens) {
        ...
        switch (token.type) {
            ...
            case WHITESPACE: type_str = "WHITESPACE"; break;
            case UNKNOWN: type_str = "UNKNOWN"; break;
            case EOF_TOKEN: type_str = "EOF"; break;
